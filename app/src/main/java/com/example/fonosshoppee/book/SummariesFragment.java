...
public class SummariesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_booksummary, container, false);
        ...
        RecyclerView rvForYou = view.findViewById(R.id.rvRecommend);
        ...
        RecyclerView rvBestSellers = view.findViewById(R.id.rvNew);
